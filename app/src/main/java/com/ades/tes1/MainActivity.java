        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long l) {
                if (position == 0) {
                    ...
                    startActivity(new Intent(MainActivity.this, Gadogado.class));
                }else if (position == 3) {
                    startActivity(new Intent(MainActivity.this, geprek.class));
                }else if (position == 4) {
                    startActivity(new Intent(MainActivity.this, martabak.class));
                }
